...
[![移动版](https://img.shields.io/github/v/release/envyafish/harbor-android-mobile-release?style=flat-square&label=mobile)](https://github.com/envyafish/harbor-android-mobile-release/releases/latest)
...
[下载](https://github.com/envyafish/Harbor-Android-TV-Release/releases/latest) · [桌面端](https://github.com/envyafish/Harbor) · [移动端](https://github.com/envyafish/harbor-android-mobile-release) · [反馈 Bug](https://github.com/envyafish/Harbor-Android-TV-Release/issues) · [购买](https://wzyp.cn/shop/767OK1ZS) · [TG 交流群](https://t.me/HarborRelease)
...
- [桌面端 Harbor](https://github.com/envyafish/Harbor) — macOS / Windows
- [移动端 Harbor](https://github.com/envyafish/harbor-android-mobile-release) — Android 手机

---

## 购买

可通过 [店铺](https://wzyp.cn/shop/767OK1ZS) 购买 Harbor Pro。同一许可证可用于桌面端、移动端与 Harbor TV。
...
| 平台 | 说明 |
|------|------|
| Android TV / Google TV（Android 7+） | 遥控 / 方向键；需 Harbor Pro |

请安装到 **电视机或电视盒子**，不要当作手机 / 平板应用使用。手机版见 [移动端](https://github.com/envyafish/harbor-android-mobile-release)，桌面版见 [Harbor](https://github.com/envyafish/Harbor)。
...
桌面端见 [Harbor](https://github.com/envyafish/Harbor)，移动端见 [Harbor Mobile](https://github.com/envyafish/harbor-android-mobile-release)。本项目不开放源代码。
